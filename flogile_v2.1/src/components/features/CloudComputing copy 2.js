      ...
      <TwoColumn>
        ...
        <TextColumn textOnLeft={textOnLeft}>
          ...
          {description1 && <Subheading>{description1}</Subheading>}
            ...
            <Popup trigger={<PrimaryButton>{primaryButtonText}</PrimaryButton>} 
  ...
  >
    {close => (
      <PopUpBox>
        ...
        <div className="header"> Enroll Cloud Computing </div>
        <div className="content">
        Please Submit your mail id  for get your enroll link on your mail
        <form>
