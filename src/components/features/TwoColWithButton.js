...
const TwoColumn = tw.div`flex flex-col md:flex-row justify-between max-w-screen-xl items-start mx-auto py-10  items-center`;
const Column = tw.div`w-full h-full max-w-full mx-auto md:max-w-none md:mx-0`;
const ImageColumn = tw(Column)`md:w-5/12  flex-shrink-0  justify-between`;
...
const Description = tw.p`mt-4 text-justify text-sm md:text-base lg:text-lg font-medium leading-relaxed text-secondary-300`;
