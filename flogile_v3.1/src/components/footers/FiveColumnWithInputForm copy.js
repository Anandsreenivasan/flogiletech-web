...
const Container = tw.div`relative bg-gray-200 text-gray-700 -mb-4 -mx-4 px-4 py-10 lg:py-5`;
    ...
    <Container>
      <Content>
        ...
        <ThreeColRow>
          ...
          <CopywrightNotice>&copy; 2021 Flogile Technologies Inc. All Rights Reserved.</CopywrightNotice>
